    ...
    return (
      <div className="flex items-center justify-center h-full min-h-64">
        <div className="text-center">
          ...
          <div className="text-gray-800 font-semibold text-lg">Assignment Created!</div>
          <div className="text-gray-500 text-sm mt-1">Redirecting to assignments...</div>
        </div>
      </div>
    );
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
              />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Subject / Department *</label>
              <select
                value={form.subject}
                onChange={e => setForm(p => ({ ...p, subject: e.target.value as Department }))}
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 resize-none"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1.5">File types automatically set based on selected department</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Optional: Add criteria for rubric-based grading</p>
            </div>
          ...
          <div className="space-y-3">
            {/* Header */}
            <div className="hidden sm:grid grid-cols-12 gap-3 text-xs font-semibold text-gray-500 px-1">
              ...
              <div key={row.id} className="grid sm:grid-cols-12 gap-3 items-start">
                <div className="sm:col-span-4">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
                  />
                </div>
                <div className="sm:col-span-2">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                  />
                </div>
